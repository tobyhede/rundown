...
function parseConditionalPrefix(rest: string, type: ConditionKind): ParsedConditional | null {
...
function isPositive(type: ConditionKind): boolean {
...
export function convertToTransitions(conditionals: ParsedConditional[]): Transitions {
  ...
  let passTransition: { kind: ConditionKind; action: Action } | null = null;
  let failTransition: { kind: ConditionKind; action: Action } | null = null;
