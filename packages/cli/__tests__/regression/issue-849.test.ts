...
// run into command work, and that follow-on's command fence then loses its
...
// green. Since #855 collect hands a core-minted directive to the same Run
// Progression driver as GOTO; this regression pins that shared path.
//
