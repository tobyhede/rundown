...
jest.unstable_mockModule('@rundown-org/core', () => ({
  ...
  // Value import in transitions.ts (real per-parent-run delegation lock for the
  // seam deps); this suite never issues delegations, so a bare constructor mock
  // satisfies the ESM named-import link check.
