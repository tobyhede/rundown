...
const forbiddenProductionPatterns = [
  ...
  ['CLI-owned loop status mapping', /\bexecutionLoopStatusFromDispatch\b/],
  ['CLI-owned terminal propagation', /\bpropagateDrivenRunTerminal\b/],
  ['CLI-owned child terminal dispatch', /\bpropagateChildTerminal\b/],
