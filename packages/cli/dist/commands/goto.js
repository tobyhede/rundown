...
import { WorkflowStateManager, parseWorkflow, parseStepIdFromString, stepIdToString, } from '@rundown/core';
...
export function registerGotoCommand(program) {
    program
        .command('goto <step>')
        .description('Jump to specific step (e.g., "3" or "3.1" for substep)')
        .action(async (stepArg) => {
