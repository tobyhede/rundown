...
import { WorkflowStateManager, parseWorkflow, evaluateFailCondition, printSeparator, printActionBlock, printWorkflowComplete, printWorkflowStoppedAtStep, createStepNumber, } from '@rundown/core';
import { resolveWorkflowFile } from '../helpers/resolve-workflow.js';
import { getCwd } from '../helpers/context.js';
import { runExecutionLoop, deriveAction, getStepRetryMax, isWorkflowComplete, isWorkflowStopped, } from '../services/execution.js';
import { withErrorHandling } from '../helpers/wrapper.js';
export function registerFailCommand(program) {
    program
        .command('fail')
        .alias('no')
        ...
        await withErrorHandling(async () => {
            ...
            if (options.agent) {
                ...
                if (binding) {
                    ...
                    const stepNum = binding.stepId.step;
