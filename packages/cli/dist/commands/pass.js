...
import { WorkflowStateManager, parseWorkflow, printSeparator, printActionBlock, printWorkflowComplete, printWorkflowStoppedAtStep, createStepNumber, } from '@rundown/core';
...
export function registerPassCommand(program) {
    program
        .command('pass')
        .aliases(['yes', 'ok'])
