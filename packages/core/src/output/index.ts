...
export {
  ...
  CapturedArtifactEntrySchema,
  ScenarioArtifactAssertionResultSchema,
  ScenarioEntrySchema,
  ...
  type ArtifactAssertionInput,
  type CapturedArtifactEntry,
  type ScenarioArtifactAssertionResult,
  type ScenarioEntry,
  type ScenarioDetail,
