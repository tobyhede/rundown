        ...
        fc.assert(
          fc.property(
            ...
            (iterations, retryCount) => {
              ...
              const events: EventType[] = Array.from({ length: maxEvents }, () => 'FAIL');
      ...
      fc.assert(
        fc.property(
          ...
          (iterations, iterationAction) => {
            ...
            const events: EventType[] = Array.from({ length: iterations + 10 }, () => 'PASS');
      ...
      fc.assert(
        fc.property(
          ...
          (iterations, numDeferSubsteps) => {
            ...
            const events: EventType[] = Array.from({ length: totalSubsteps + 10 }, () => 'FAIL');
