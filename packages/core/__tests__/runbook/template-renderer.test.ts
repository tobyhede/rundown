...
import type { StepVariables } from '../../src/runbook/index.js';
import {
...
function withTestHelpers(options?: TemplateRenderOptions): TemplateRenderOptions {
...
function substituteText(
  ...
  return coreSubstituteText(text, variables, escapeFn, withTestHelpers(helperOptions));
}

function expandLoopVariables(
  text: string,
  variables: Readonly<StepVariables>,
  helperOptions?: TemplateRenderOptions,
): string {
  return coreExpandLoopVariables(text, variables, withTestHelpers(helperOptions));
}

function expandLoopVariablesForCommand(
  text: string,
  variables: Readonly<StepVariables>,
  helperOptions?: TemplateRenderOptions,
): string {
  return coreExpandLoopVariablesForCommand(text, variables, withTestHelpers(helperOptions));
}

function substituteRunbookVariables(
  runbook: Parameters<typeof coreSubstituteRunbookVariables>[0],
  variables: Record<string, unknown>,
  helperOptions?: TemplateRenderOptions,
): ReturnType<typeof coreSubstituteRunbookVariables> {
  return coreSubstituteRunbookVariables(runbook, variables, withTestHelpers(helperOptions));
}
