...
| `RD-829` (`DELEGATION_FRONTIER_CONSUME_FAILED`) | A persisted delegation re-entry frontier projected, but the machine did not accept the consume, so it is still pending and no bearer was disclosed. Emitted by the execution loop (the run stops) and by `rundown collect` (`reason: 'frontier_consume_failed'`)                                                                                                          | Transient — repeat the operation. The next attempt re-projects and re-consumes the same frontier                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
