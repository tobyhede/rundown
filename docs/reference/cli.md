...
| `RECOVERY_REQUIRED`                              | The named run's last execution attempt ended without recording an outcome, so whether its effect ran is unknown. Unlike `EXECUTION_IN_PROGRESS`, no process holds it and waiting will not clear it                                                                                                                                                                                                                                                                                             | There is no `rundown recover` command — recovery is automatic, driven inline by the command that owns the named run's execution, for the exact epoch this refusal names. Nothing was written here; retry once that recovery has completed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
