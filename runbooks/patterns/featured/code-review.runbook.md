...
scenarios:
  approved:
    ...
    commands:
      ...
      - rd pass  # 1 Automated Checks
      - rd yes   # 2 Self Review
      - rd pass  # 3 Peer Review
      - rd pass  # 4 Merge - COMPLETE
    result: COMPLETE
  changes-requested:
    ...
    commands:
      ...
      - rd pass  # 1 Automated Checks
      - rd yes   # 2 Self Review
      - rd fail  # 3 Peer Review - RETRY
      - rd pass  # 3 Peer Review (retry)
      - rd pass  # 4 Merge - COMPLETE
    result: COMPLETE
  automated-failure:
    ...
    commands:
      - rd run --prompted code-review.runbook.md
      - rd fail  # 1 Automated Checks - STOP
    result: STOP
---
...
```bash
rd echo gh pr status --json reviewDecision
```
